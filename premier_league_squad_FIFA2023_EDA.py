...
############################################################ FIFA 2023 PLAYER DATA Cleaning #################################################

# Reading the FIFA 2023 player data CSV file in a pandas dataframe
...
# using unidecode library to remove accents and convert special characters to their closest ASCII representation.
...
# plitting first and last name into two separate lists
...
# Using the 'to_sql' method to write the DataFrame to an SQLite table

fifa_player_data_df.to_sql("fifa_player_data", conn, if_exists="replace", index=False)


#################################################### ARSENAL SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################

# Reading the arsenal_ CSV file in a pandas DataFrame
...
# Defining a custom function to create a "First_Name_initial" list to later JOIN with the FIFA 2023 Player Data when using SQLite
...
# Applying the custom function in order to create the "First_Name_initial" column
...
# creating a new column with the column name "Club_Name" where all rows will be "Arsenal" this is to help with JOING with SQL queries
...
# Utilising the 'to_sql' method to write the DataFrame to an SQLite table
...
# Fetching all the results into a list
arsenal_results = arsenal_cursor.fetchall()

# Printing the results with padding to align in columns
...
# Creating a set of full names and last names for players retrieved in the SQLite query
arsenal_retrieved_players = set((row[1], row[2]) for row in arsenal_results)

# Filtering the arsenal_df DataFrame to get rows not retrieved
...
# Printing the unretrieved players information including first name initial, first name initial, last name and player nationality
...
# Closing the cursor and the connection for Arsenal
arsenal_cursor.close()


################################################ man_city_ SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################


# Reading man_city_ CSV file in a pandas DataFrame
...
# Applying a custom function to create the "First_Name_initial" column
...
# creating a new column with the column name "Club_Name" where all rows will be "Manchester City" this is to help with JOING with SQL queries
...
# Creating a cursor for man_city
...
# Fetching all the results into a list for man_city
...
# Filtering the man_city_df DataFrame to get rows not retrieved
...
# Closing the cursor and the connection for man_city
man_city_cursor.close()


####################################################### LIVERPOOL SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################

# Reading liverpool_ CSV file in a pandas DataFrame
...
# creating a new column with the column name "Club_Name" where all rows will be "Liverpool" this is to help with JOING with SQL queries
...
# Creatig  a cursor for the Liverpool squad
liverpool_cursor = conn.cursor()

# Executing SQL queries for the liverpool squad
...
# Filtering the liverpool_df DataFrame to get rows not retrieved
...
# Closing the cursor and the connection for Liverpool
liverpool_cursor.close()


################################################ MAN UNITED SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################


# Reading the man_united CSV file in a pandas DataFrame
...
# Applying the custom function to create the "First_Name_initial" column
...
# creating a new column with the column name "Club_Name" where all rows will be "Manchester United" this is to help with JOING with SQL queries
...
# Creating a cursor for man_united
man_united_cursor = conn.cursor()

# Executing SQL queries for man_united
...
# Filtering the man_united_df DataFrame to get rows not retrieved
...
# Closing the cursor and the connection for man_united
man_united_cursor.close()

################################################## CHELSEA SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################

# Reading the chelsea CSV file in a pandas DataFrame
...
# creating a new column with the column name "Club_Name" where all rows will be "Chelsea" this is to help with JOING with SQL queries
...
# Creating a cursor for the chelsea squad
chelsea_cursor = conn.cursor()

# Executing SQL queries for the chelsea squad
...
# Filtering the chelsea_df DataFrame to get rows not retrieved
...
# Closing the cursor and the connection for the chelsea squad
chelsea_cursor.close()


################################################### NEWCASTLE SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################


# Reading  the newcastle CSV file in a pandas DataFrame
...
# Applying the custom function to create the "First_Name_initial" list
...
# creating a new column with the column name "Club_Name" where all rows will be "Newcastle United" this is to help with JOING with SQL queries
...
# Creating a cursor for newcastle
newcastle_cursor = conn.cursor()

# Executing SQL queries for newcastle dataframe
...
# Fetching all the results into a list from the sql queries
...
# Filtering the newcastle_df DataFrame to get rows not retrieved
...
# Close the cursor and the connection for newcastle dataframe
newcastle_cursor.close()

################################################# TOTTENHAM SQUAD 2023/2024 Data cleaning, and SQLite querying ########################################


# Reading the tottenham CSV file in a pandas DataFrame
...
# creating a new column with the column name "Club_Name" where all rows will be "Tottenham Hotspur" this is to help with JOING with SQL queries
...
# Creating a cursor for tottenham dataframe
...
# Fetching all the results into a list from the sql query
...
# Filtering the tottenham_df DataFrame to get rows not retrieved
...
# Closing the cursor and the connection for the tottenham dataframe
...
# Creating a DataFrame from the calculated ratings
team_ratings_df = pd.DataFrame(team_ratings_data)

# Seting the "Club Names" column as the index
team_ratings_df.set_index("Club Names", inplace=True)

# Ploting a grouped bar chart
ax = team_ratings_df.plot(kind="bar", figsize=(12, 8), width=0.8)

# Seting labels and title for the  bar chart
